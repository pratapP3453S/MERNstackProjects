...
const Footer = () => {
  ...
  return (
    <>
      <footer className="mt-20 w-full py-1 sm:py-4 px-4 sm:px-12 footerColor text-white text-xs border-b border-gray-600 flex flex-col sm:flex-row overflow-hidden">
        <div className="w-full sm:w-7/12 flex flex-col sm:flex-row">
          {footerLinks.map((el, i) => (
            <div
              ...
              key={i}
            >
              <h2 className="text-gray-400 font-bold mb-2 uppercase">
                {el.title}
              </h2>
              {el.links.map((item, i) => (
                <a
